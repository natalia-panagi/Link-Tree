let links = [
  {
    text: "🌿Detox Time - 15%Off on Detox Supplements",
...
let thumbnailsData= [
  {
    text: "Loose weight without injections",
...
{text: "True Italian Elegance for You",
...
{text:"Ideal Magnesium for Active Life",
